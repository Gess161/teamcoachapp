  ...
  return (
    <div className="glass-card p-6">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="font-display font-semibold">{t("charts.qualities")}</h2>
      </div>
      <p className="text-xs text-muted-foreground mb-3">{t("charts.qualitiesHint")}</p>
      <ResponsiveContainer width="100%" height={210}>
        <RadarChart data={data}>
          ...
          <Tooltip
            ...
            formatter={(v: number) => [`${v}%`, t("charts.emphasis")]}
          />
        </RadarChart>
      </ResponsiveContainer>
    </div>
