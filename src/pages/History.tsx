...
const PLATONOV_DISTRIBUTION: Record<MacroPhaseKey, Record<PrepType, number>> = {
...
const PHASE_NAMES: Record<MacroPhaseKey, string> = {
...
const BAR_COLORS: Record<PrepType, string> = {
  ЗФП:      "bg-blue-500",
  СФП:      "bg-violet-500",
